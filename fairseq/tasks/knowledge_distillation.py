...
from fairseq.data import KDAudioDataset, Dictionary, AddTargetDataset
...
@register_task("knowledge_distillation")
class KnowledgeDistillationTask(LegacyFairseqTask):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default='flac',
            help="extension of the pre-computed feature files",
        )
